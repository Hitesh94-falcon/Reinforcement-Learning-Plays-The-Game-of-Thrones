...
csv_path =r"D:\Thi\Padm\experimentation\logs\log(2).csv"
...
def train_q_learning(env,
                     ...
                     alpha,
                     gamma,
                     q_table_kingdom_save_path="D:\Thi\Padm\experimentation\q_tables\q_table_kingdom.npy",
                     q_table_goal_save_path ="D:\Thi\Padm\experimentation\q_tables\q_table_goal.npy"):
...
# -----------
def visualize_q_table(q_values_path,hell_state_coordinates=[(2,1),(2,4),(5,3),(0,3)], actions=["Up", "Down", "Right", "Left"]):
    try:
        q_table = np.load(q_values_path)

        _, axes = plt.subplots(1, 4, figsize=(20, 5))

        goal_coordinates = (5,5)  # (row, column)
