...
if visualize_results:
    ...
    # ----------------------
    visualize_q_table(q_values_path="D:\Thi\Padm\experimentation\q_tables\q_table_kingdom.npy")

    visualize_q_table(q_values_path="D:\Thi\Padm\experimentation\q_tables\q_table_goal.npy")
